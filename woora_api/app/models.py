...
class PropertyValue(db.Model):
    ...
    value_decimal = db.Column(db.Numeric(20, 2), nullable=True)
...
class Property(db.Model):
    ...
    def to_dict(self):
        ...
        base_data = {
            ...
            'address': self.address, 'city': self.city, 'country': self.country, 'postal_code': self.postal_code,
...
class PayoutRequest(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    agent_id = db.Column(db.Integer, db.ForeignKey('Users.id', ondelete='CASCADE'), nullable=False)
    requested_amount = db.Column(db.Numeric(20, 2), nullable=False)
    actual_amount = db.Column(db.Numeric(20, 2), nullable=True)
